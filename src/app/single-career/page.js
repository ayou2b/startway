...
function Page() {
  ...
  return (
    <Fragment>
      <Header></Header>
      <section className="mb-20 px-14 sm:px-16 text-center lg:text-start gap-10 md:px-20 lg:px-24 xl:px-28 mt-14 flex flex-col items-center lg:items-start lg:flex-row lg:justify-between w-full">
      ...
      <section className="mb-20 px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 text-center w-full lg:text-start">
        <div className="bg-[#ECF8F9] py-14 pt-0 flex flex-col gap-10 w-full">
      ...
      <section className="px-14 mb-20 sm:px-16 md:px-20 lg:px-24 xl:px-28 text-center w-full lg:text-start flex flex-col items-center lg:items-start gap-8">
        <h2 className="text-[25px] font-semibold text-[#232536]">Apply Now</h2>
