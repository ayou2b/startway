...
function page() {
  return (
    <Fragment>
      ...
      <section className="px-14 transition-all gap-10 sm:px-16 md:px-20 lg:px-24 xl:px-28 w-full mt-14 mb-20 text-center lg:text-start flex flex-col items-center lg:items-start lg:justify-between lg:flex-row">
        ...
        <div className="bg-[#666DFF] text-white p-12 max-w-md w-full flex flex-col items-center lg:items-start gap-6">
          ...
          <div className="w-full flex flex-col items-center lg:items-start gap-2">
            ...
            <span className="  text-[#e3e3e3] w-full">startaway@ether.com</span>
          </div>
