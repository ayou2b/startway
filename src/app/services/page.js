...
function page() {
  return (
    <Fragment>
      ...
      <section className="lg:h-[90vh] py-12 mb-20 lg:py-14 gap-10 px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 bg-[#FFE6D2] text-center lg:text-start flex flex-col items-center lg:flex-row lg:justify-between w-full">
      ...
      <section className="mb-20 px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 w-full text-center lg:text-start flex flex-col items-center gap-10 lg:flex-row lg:justify-between">
      ...
      <section className="bg-[#ECF8F9] py-5 mb-20 px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 w-full text-center lg:text-start flex flex-col items-center gap-10 lg:flex-row-reverse lg:justify-between">
        <div className="max-w-md flex flex-col items-center lg:items-start gap-3">
          <span className="text-[#444CFC] uppercase tracking-wider font-medium">
            Developoment
          </span>
      ...
      <section className="mb-20 px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 w-full text-center lg:text-start flex flex-col items-center gap-10 lg:flex-row-reverse lg:justify-between">
        <div className="max-w-md flex flex-col items-center lg:items-start gap-3">
          <span className="text-[#444CFC] uppercase tracking-wider font-medium">
            Consulting
          </span>
