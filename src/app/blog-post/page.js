...
function page() {
  return (
    <Fragment>
      ...
      <section className="px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 mt-14 mb-14 flex items-center justify-center text-center lg:text-start">
        <div className=" 2xl:max-w-[1300px] flex items-center w-full lg:items-start">
      ...
      <section className="px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 flex items-center justify-center mb-14">
        <Image
          src={image}
          alt=""
          className="h-64 2xl:max-w-[1300px] object-cover w-full"
        ></Image>
      </section>

      <section className="px-16 sm:px-20 md:px-28 lg:px-40 xl:px-44 text-center lg:text-start flex items-center justify-center mb-20">
        <div className="w-full 2xl:max-w-[1300px] flex flex-col items-center lg:items-start gap-5">
