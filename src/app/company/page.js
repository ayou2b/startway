  ...
  return (
    <Fragment>
      ...
      <section className="px-14 mt-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 mb-20 w-full text-center lg:text-start flex items-center justify-center">
        <div className="w-full 2xl:max-w-[1300px] flex flex-col items-center gap-5 lg:items-start">
          ...
          <div className="flex w-full flex-col gap-6 items-center md:grid md:grid-cols-3">
            <Image
              src={image_1}
              alt=""
      ...
      <section className="px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 mb-20 w-full lg:gap-20 text-center lg:text-start flex items-center justify-center">
        <div className="w-full 2xl:max-w-[1300px] flex flex-col items-center gap-12 lg:flex-row lg:justify-between ">
      ...
      <section className="px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 mb-20 w-full flex items-center justify-center">
        <div className="bg-[#FAFAFC] flex w-full 2xl:max-w-[1300px] flex-col items-center gap-5 md:grid md:grid-cols-2 md:place-items-center lg:flex lg:flex-row lg:justify-between px-10">
      ...
      <section className="bg-[#ECF8F9] mb-20 py-12 lg:py-14  px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 w-full text-center lg:text-start flex items-center justify-center">
      ...
      <section className="px-14 mb-20 sm:px-16 md:px-20 lg:px-24 xl:px-28 w-full text-center lg:text-start flex items-center justify-center ">
      ...
      <section className="px-14 mb-20 sm:px-16 md:px-20 lg:px-24 xl:px-28 w-full text-center lg:text-start  flex items-center justify-center">
        <div className="w-full max-w-[1300px] flex flex-col items-center gap-8 lg:items-start">
          <div className="flex flex-col items-center lg:items-start gap-3 max-w-md">
            <span className="text-[#5D5F6D] tracking-wider uppercase">
              MEET OUR TEAM
            </span>
