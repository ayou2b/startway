...
export default function Home() {
  ...
  return (
    <Fragment>
      ...
      <section className="py-12 mb-20 lg:py-14 px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 bg-[#232536] text-white w-full flex items-center justify-center text-center lg:text-start">
        <div className="flex flex-col items-center lg:items-start 2xl:max-w-[1300px] gap-10 w-full">
          ...
          <div className="flex flex-col items-center gap-12 lg:flex-row w-full  lg:justify-between">
            ...
            <div className="flex flex-col items-center  lg:flex md:flex-row gap-5 w-[80%] lg:justify-between">
      ...
      <section className="px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 mb-20 w-full text-center lg:text-start  flex items-center justify-center">
        <div className="flex flex-col w-full items-center gap-8 lg:items-start  2xl:max-w-[1300px]">
          ...
          <div className="flex flex-col gap-6 items-center md:grid md:grid-cols-3 md:place-content-between w-full">
            <Image
              src={image_1}
              alt=""
      ...
      <section className="bg-[#ECF8F9] py-12 lg:py-14  px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 w-full text-center lg:text-start  flex items-center justify-center">
        <div className="w-full 2xl:max-w-[1300px] flex flex-col items-center gap-10 md:flex-row md:justify-between md:items-start">
      ...
      <section className="bg-[#FFE6D2] mb-20 py-12 lg:py-14  px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 w-full text-center lg:text-start flex items-center justify-center">
      ...
      <section className="bg-[#F9F9FF] py-12 lg:py-14 text-center lg:text-start  px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 w-full flex items-center justify-center">
        <div className="w-full 2xl:max-w-[1300px] flex flex-col items-center gap-8 lg:flex-row lg:justify-between">
      ...
      <section className="bg-[#ECF8F9] mb-20 py-12 lg:py-14  px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 w-full flex items-center justify-center text-center lg:text-start">
      ...
      <section className="w-full flex items-center justify-center px-14 mb-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 text-center lg:text-start">
        <div className="bg-[#666DFF] p-10 flex flex-col items-center lg:flex-row lg:justify-between w-full 2xl:max-w-[1300px] gap-10">
      ...
      <footer className="w-full  px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 flex items-center justify-center text-center md:text-start">
      ...
      <div className="bg-[#FFE6D2] w-full py-6 mt-8 px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 text-center md:text-start flex items-center justify-center">
        <div className="w-full 2xl:max-w-[1300px] flex flex-col items-center md:flex-row md:justify-between gap-4">
          <h1 className="text-[20px] font-bold">
            <Link href="/">STARTWAY</Link>
          </h1>
